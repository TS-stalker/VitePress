...
![Image Description](../../images/Controls/日历/1.png)
...
![Image Description](../../images/Controls/日历/2.gif)
...
| Picker Type       | Set the content format displayed by the calendar, including Datetime and Date.<br />When Datetime is selected, the control can select year, month, day, hour, minute, and second;<br />![Image Description](../../images/Controls/日历/3.png)<br />When Date is selected, only year, month, and day can be selected.<br />![Image Description](../../images/Controls/日历/4.png) |
...
| Background        | The background color of the control.<br />![Image Description](../../images/Controls/日历/5.png)                                                                                                                                                                                                                                                                                 |
| Picker Background | The background color of the calendar window that pops up from the control.<br />![Image Description](../../images/Controls/日历/6.png)                                                                                                                                                                                                                                           |
