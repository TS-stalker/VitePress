...
![Image Description](../../images/Controls/数字输入框/1.png)
...
| Out-of-Range Prompt | Set whether to enable out-of-range prompts. When enabled, you can set the out-of-range prompt content.<br />![Image Description](../../images/Controls/数字输入框/4.png)<br />Error Prompt Effect:<br />![Image Description](../../images/Controls/数字输入框/5.png)<br />Note: Out-of-range prompts only take effect when boundary values are enabled. |
| Fill                | The background color of the digital input box.<br />![Image Description](../../images/Controls/数字输入框/6.png)                                                                                                                                                                                                                                        |
