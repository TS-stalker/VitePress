...
![Image Description](../../images/Controls/digitalinputbox/1.png)
...
![Image Description](../../images/Controls/digitalinputbox/2.gif)

Figure 1-1

This example mainly simulates binding variables to digital input boxes for data display. As shown in Figure 1-2.

![Image Description](../../images/Controls/digitalinputbox/3.gif)
...
| Out-of-Range Prompt | Set whether to enable out-of-range prompts. When enabled, you can set the out-of-range prompt content.<br />![Image Description](../../images/Controls/digitalinputbox/4.png)<br />Error Prompt Effect:<br />![Image Description](../../images/Controls/digitalinputbox/5.png)<br />Note: Out-of-range prompts only take effect when boundary values are enabled. |
| Fill                | The background color of the digital input box.<br />![Image Description](../../images/Controls/digitalinputbox/6.png)                                                                                                                                                                                                                                             |
