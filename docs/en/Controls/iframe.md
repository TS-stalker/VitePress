...
![Image Description](../../images/Controls/内嵌网页/1.png)
...
![Image Description](../../images/Controls/内嵌网页/2.gif)
...
| Iframe        | Address<br />Enter the webpage IP address to display the corresponding webpage<br />![Image Description](../../images/Controls/内嵌网页/3.png)<br />Parameters<br />You can customize the parameters after the IP address in the address bar, which will be automatically concatenated after the IP address in the address bar to form a new IP address |
