...
![图片描述](../images/Controls/数字输入框/1.png)
...
![图片描述](../images/Controls/数字输入框/2.gif)

图 1-1

该实例主要是模拟将变量绑定到数值输入框，进行数据展示。如图1-2所示

![图片描述](../images/Controls/数字输入框/3.gif)
...
| 超限提示 | 设置是否启用越界提示。启用时，可以设置越界提示内容。<br />![图片描述](../images/Controls/数字输入框/4.png)<br />错误提示效果：<br />![图片描述](../images/Controls/数字输入框/5.png)<br />说明：越界提示必须在边界值启用时才会生效。 |
| 填充     | 数字输入框的背景色。<br />![图片描述](../images/Controls/数字输入框/6.png)                                                                                                                                                           |
| 边框颜色 | 数字输入框的边框颜色。                                                                                                                                                                                                               |
| 边框粗细 | 数字输入框的边框粗细。                                                                                                                                                                                                               |
