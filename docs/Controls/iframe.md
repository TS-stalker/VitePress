...
![图片描述](../images/Controls/iframe/1.png)
...
![图片描述](../images/Controls/iframe/2.gif)
...
| 内嵌网页 | 地址<br />输入网页IP地址，即可显示相应的网页<br />![图片描述](../images/Controls/iframe/3.png)<br />参数<br />可以自定义对地址栏里面的IP地址后面的参数，自动拼接到地址栏IP地址后面形成新的IP地址 |
