...
![图片描述](../images/Controls/复选框/1.png)
...
![图片描述](../images/Controls/复选框/2.gif)
...
| 透明度 | 控件的透明度                                                                                                                                 |
| 选中   | 控件的选中状态。                                                                                                                             |
| 填充   | 控件的填充色。<br />![图片描述](../images/Controls/复选框/3.png)<br />控件显示的文本内容。<br />![图片描述](../images/Controls/复选框/4.png) |
| 边框色 | 控件的边框色。<br />![图片描述](../images/Controls/复选框/5.png)                                                                             |
