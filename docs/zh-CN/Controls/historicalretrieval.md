...
![图片描述](../../images/Controls/historicalretrieval/1.png)
...
![图片描述](../../images/Controls/historicalretrieval/2.gif)
...
| 时间范围                                 | 按照设置的时间段进行查询。<br />![图片描述](../../images/Controls/historicalretrieval/3.png)                                           |
| 采集方法                                 | 设置采集方法<br />![图片描述](../../images/Controls/historicalretrieval/4.png)                                                         |
| 数据                                     | 点击数据的绑定按钮，打开数据集绑定变量。只能绑定开启了历史存储的变量<br />![图片描述](../../images/Controls/historicalretrieval/5.png) |
